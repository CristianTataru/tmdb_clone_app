...
abstract class $SpokenLanguageCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: "english_name") String name});
}
...
class _$_SpokenLanguage implements _SpokenLanguage {
  const _$_SpokenLanguage({@JsonKey(name: "english_name") required this.name});
...
abstract class _SpokenLanguage implements SpokenLanguage {
  const factory _SpokenLanguage(
          {@JsonKey(name: "english_name") required final String name}) =
      _$_SpokenLanguage;
